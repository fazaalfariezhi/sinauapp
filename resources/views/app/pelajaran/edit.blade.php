  ...
  <section class="section">
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-lg-8">
          <div class="card">
            <form action="/pelajarans/{{ $pelajaran->slug }}" method="POST" id="isDirty" enctype="multipart/form-data" onsubmit="setFormSubmitting()">
                @csrf
                @method('put')
                <div class="card-header">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama', $pelajaran->nama) }}" required>
                      @error('nama')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $pelajaran->slug) }}" required>
                      @error('slug')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="custom-select" name="jenjang_id">
                        ...
                        @if (old('jenjang_id', $pelajaran->jenjang_id) == $jenjang->id)
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" name="oldImage" value="{{ $pelajaran->image }}">
                      @if ($pelajaran->image)
                        <img src="{{ asset('storage/' . $pelajaran->image) }}" class="img-preview img-fluid mb-3 img-thumbnail col-sm-5 d-block" style="max-height: 400px;">
                      @else
